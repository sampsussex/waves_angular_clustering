...
if __name__ == '__main__':
    print("Running WAVES angular clustering...")
    print('Initializing clustering class with file paths and parameters...')
    ww = WavesWideClustering(
        ...
        results_directory  = '/mnt/lustre/projects/astro/general/sp624/angular_clustering_waves/results_20260515/',
    )
    print('Getting clustering results for all selections to run...')
