...
if __name__ == '__main__':
    ww = WavesWideClustering(
        ...
        results_directory  = '/mnt/lustre/projects/astro/general/sp624/angular_clustering_waves/20260720_Z211_total_mask+_wwn_cut_final/',
    )
    ...
    n_randoms_filepath = '/mnt/lustre/projects/astro/general/sp624/waves_randoms/waves-wide_n_randoms.parquet',
    s_randoms_filepath = '/mnt/lustre/projects/astro/general/sp624/waves_randoms/waves-wide_s_randoms.parquet',
    results_directory  = '/mnt/lustre/projects/astro/general/sp624/angular_clustering_waves/20260720_Z211_colour_mask+_wwn_cut_final/',
    photom_type = 'colour'
    )
